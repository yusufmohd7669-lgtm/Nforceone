...
export function InsightCard({ insight, className }: InsightCardProps) {
  return (
    <Link
      ...
      className={cn(
        "group flex flex-col justify-between p-6 md:p-8 rounded-xl bg-bg-card border border-border transition-all duration-300 hover:border-accent/60 hover:bg-bg-raised hover:-translate-y-1",
        className
      )}
    >
      <div>
